<div class="col-md-6">
    <div class="card shadow h-100">
        ...
        <div class="card-body">
            ...
            @endif
            <form id="update-password-form" method="POST" class="ajax-update-form" action="{{ route('user.update-password') }}">
                @csrf
                @method('patch')
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <button type="submit" class="btn btn-primary btn-block" data-toggle="modal" data-target="#application-modal"
                            onclick="callModal('update-password-form', 
                            {
